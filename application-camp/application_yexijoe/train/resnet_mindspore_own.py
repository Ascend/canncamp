...
class ResNet(nn.Cell):
    ...
    def __init__(self,
        ...
        if self.use_se:
            ...
            self.conv1 = _conv7x7(1, 64, stride=2)  # _conv7x7(3, 64, stride=2)///////////////////
        self.bn1 = _bn(64)
        self.relu = P.ReLU()
        self.maxpool = nn.MaxPool2d(kernel_size=(1, 3), stride=(1, 2), pad_mode="same")  # 3, 2//////////
    ...
    def construct(self, x):
        ...
        c3 = self.layer2(c2)
        # print(c3.shape, "============================c3==================================")
        c4 = self.layer3(c3)  # (128, 512, 1, 16)
        # print(c4.shape, "============================c4==================================")
        # c5 = self.layer4(c4)  # delete////////////////////////////////////////

        # out = self.mean(c5, (2, 3))
        out = self.mean(c4, (2, 3))  # (128, 2048, 1, 1)
        # print(out.shape, "============================out==================================")
        out = self.flatten(out)  # (128, 2048)
        # print(out.shape, "============================out==================================")
...
def resnet50(class_num=10):
    ...
    return ResNet(ResidualBlock,
                  [3, 4, 6, 3],
                  [64, 256, 512, 1024],
                  [256, 512, 2 * 1024, 2048],  # [256, 512, 1024, 2048]///////////////////////
                  [1, 2, 2, 2],
                  class_num)
